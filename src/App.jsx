...
export default function App() {
  ...
  return (
    <>
      ...
      <form className="container d-flex flex-wrap justify-content-evenly" onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn btn-primary text-center px-4">Invia</button>
      </form>
    </>
  );
}
